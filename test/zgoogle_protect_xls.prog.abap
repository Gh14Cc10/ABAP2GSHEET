...
ENDTRY.
**********************************************************************
* Send / Receive Request (Just the GET)
**********************************************************************
CLEAR lt_fields.
...
DATA: lv_request type string,
      lv_req1 type string,
      lv_req2 type string.
lv_req1 =  '{"requests": [{"addProtectedRange":{"protectedRange":{"range":{"sheetId":337906445,"startRowIndex":1,"endRowIndex":20,"startColumnIndex":6,"endColumnIndex":7},"description":"Protecting total row",'.
...
CONCATENATE lv_req1 LV_REQ2 INTO lv_request.
