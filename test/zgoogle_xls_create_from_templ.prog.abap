*&---------------------------------------------------------------------*
*& Report ZGOOGLE_XLS_CREATE_FROM_TEMPL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZGOOGLE_XLS_CREATE_FROM_TEMPL.
...
GOBJECT->SEND_GET_REQUEST(
  exporting
*    PROFILE    =     'Z_GOOGLE_CL_PROFILE'" OAuth 2.0 Client Profile
*    TARGET =          'http://requestbin.net/r/1god6ot1'
*    TARGET     =     'https://www.googleapis.com/drive/v3/files/158RnStrh_BneB8iePpp8QLpzSAeB6c-MfWSXL6yhsWk'
    TARGET      =      'https://www.googleapis.com/drive/v2/files/158RnStrh_BneB8iePpp8QLpzSAeB6c-MfWSXL6yhsWk/export'
    METHOD     =     'GET'
    PARAM_KIND =      'H'
