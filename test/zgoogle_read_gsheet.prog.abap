*&---------------------------------------------------------------------*
*& Report ZGOOGLE_READ_XLS
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZGOOGLE_READ_GSHEET.
...
target = 'https://sheets.googleapis.com/v4/spreadsheets/$1?includeGridData=true'.
REPLACE '$1' IN target WITH p_url.
...
*lv_reqUpdate = '{"role":"$1","type":"user","emailAddress":"$2"}'.

*
*REPLACE '$1' IN lv_reqUpdate WITH p_role.
*REPLACE '$2'  IN lv_reqUpdate WITH p_mail.
